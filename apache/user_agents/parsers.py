...
import sys
from Container import namedtuple
from apache.ua_parser import user_agent_parser
...
Browser = namedtuple.namedtuple('Browser', ['family', 'version', 'version_string'])
...
OperatingSystem = namedtuple.namedtuple('OperatingSystem', ['family', 'version', 'version_string'])
...
Device = namedtuple.namedtuple('Device', ['family', 'brand', 'model'])
